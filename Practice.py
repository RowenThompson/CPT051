...
print("~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~")
print("Covered Area                     " + str(coveredSquareFootage_format) + ' sq.ft')
print("Uncovered Area                   " + str(uncoveredSquareFootage_format) + ' sq.ft')
print("~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~")
print("Sod Name                         " + sodName)
print("Sod Price (per sq.ft.)           " + CURRENCY + str(sodPrice))
